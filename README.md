...
- I've added `to_json` to validator logic which breaks sibgle responsibility pronciple, but avoids duplicated hash to json operation which could be costly on large data.
